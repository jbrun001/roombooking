...
app.use((req, res, next) => {
  ...
  var cSPolicy = "default-src http://localhost:8000 https://www.doc.gold.ac.uk; "; // will need changing when installed
  cSPolicy =
    cSPolicy +
    "script-src http://localhost:8000 https://www.doc.gold.ac.uk https://ajax.googleapis.com 'unsafe-inline'; "; // unsafe-inline allows for script in the pages
  cSPolicy =
    cSPolicy +
    "img-src 'self' data: https://cdn3.iconfinder.com https://i.imgur.com; ";
  cSPolicy = cSPolicy + "style-src https://www.doc.gold.ac.uk http://localhost:8000 'unsafe-inline'; ";
  cSPolicy = cSPolicy + "font-src https://www.doc.gold.ac.uk http://localhost:8000; ";
  cSPolicy = cSPolicy + "frame-ancestors https://www.doc.gold.ac.uk http://localhost:8000; "; // stops the page being used within external websites
  cSPolicy = cSPolicy + "form-action https://www.doc.gold.ac.uk http://localhost:8000; "; // only allow form submission to the server running the app
